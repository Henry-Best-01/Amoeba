...
class Agn:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.gravitational_radius = calculate_gravitational_radius(10**self.smbh_mass_exp)
    ...
    def visualize_torus_obscuration(self, obscuration_strength, **kwargs):
        ...
        torus_extinction.flux_array = np.exp(-torus_extinction.flux_array * obscuration_strength)
    ...
    def update_smbh_mass_exponent(self, new_smbh_mass_exponent):
        ...
        if self.disk_is_updatable == False:
            print("accretion disk is not updatable, temperature profile will not be consistent")
        ...
        elif "accretion_disk" in self.components.keys and self.disk_is_updatable == False:
    ...
    def calculate_accretion_disk_transfer_function(self, observed_wavelength_in_nm, **kwargs):
