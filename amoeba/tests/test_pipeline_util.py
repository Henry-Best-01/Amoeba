...
def test_intrinsic_signal_propogation_pipeline():
    ...
    npt.assert_almost_equal(np.sum(abs(my_other_only_signal[0][0] - alt_my_only_other_signal[0][0])), 0)
    npt.assert_almost_equal(np.sum(abs(my_other_only_signal[0][1] - alt_my_only_other_signal[0][1])), 0)
