...
diffuse_continuum_spectra_emissivities = [0.05, 0.07, 0.19, 0.08, 0.45, 0.15, 0.37, 0.2, 0.25]
constant_a = 0.5
...
ax[3].plot(dc_spectrum, total_increased_lags / mean_lag_dc, label=r"$\alpha$ = "+str(constant_a))
...
ax[3].plot(dc_spectrum, total_increased_lags / mean_lag_dc, label=r"$\alpha$ = "+str(const_a))
